...
const stats = [
  ...
  { icon: <Coffee />, label: 'Freelancers Team', value: '4' },
  { icon: <Heart />, label: 'Happy Clients', value: '8+' },
];
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          <div className="space-y-6 animate-fade-in">
            <p className="text-lg text-gray-600 dark:text-gray-300">
              ...
              beautiful and functional web applications. With over 2 years of experience
            ...
            <p className="text-lg text-gray-600 dark:text-gray-300">
              ...
              my skills to stay up-to-date with the latest technologies and best practices like SOLID and DRY principle with scaleble system design.
            </p>
