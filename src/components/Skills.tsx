...
const skills: Skill[] = [
  ...
  { name: 'Backend Development', icon: <Server />, level: 70, category: 'Development' },
  { name: 'Database Management', icon: <Database />, level: 60, category: 'Development' },
  ...
  { name: 'Cloud Services', icon: <Cloud />, level: 10, category: 'Tools' },
