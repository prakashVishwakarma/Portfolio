        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
          ...
          <div className="space-y-8">
            ...
            <div className="space-y-6">
              {[
                { icon: <Mail />, label: 'Email', value: 'prakash.official.dev@gmail.com' },
                { icon: <Phone />, label: 'Phone', value: '6232749876' },
                { icon: <MapPin />, label: 'Location', value: 'Korba Chhattisgarh, INDIA' },
              ].map((item, index) => (
                <div
                  key={item.label}
